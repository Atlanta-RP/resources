...
Radio.Labels = {        
	{ "FRZL_RADIO_HELP", "~s~" .. ("/radio") .. " para esconder.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ para deixar o radio ~g~LIGADO~s~.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ ou ~" .. radioConfig.Controls.Increase.Name .. "~ para escolher a frequência ~n~~" .. radioConfig.Controls.Input.Name .. "~ to choose frequency~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ para ~a~ som do radio~n~Frequencia atual: ~1~ MHz" },
	{ "FRZL_RADIO_HELP2", "~s~" .. ("/radio") .. " para esconder..~n~~" .. radioConfig.Controls.Toggle.Name .. "~  para deixar o radio ~r~DESLIGADO~s~.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ para falar.~n~Frequency: ~1~ MHz" },
	{ "FRZL_RADIO_INPUT", "Entrar na frequência" },
}
Radio.Commands = {
	{
...
function Radio:Toggle(toggle)
	...
	if self.Open then
		...
		AttachEntityToEntity(playerPed, bone, self.Offset.x, self.Offset.y, self.Offset.z, self.Rotation.x, self.Rotation.y, self.Rotation.z, true, false, false, false, 2, true)
