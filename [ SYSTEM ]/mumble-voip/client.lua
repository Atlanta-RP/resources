...
RegisterKeyMapping("+voiceMode", "Altera distancia da voz", "keyboard", mumbleConfig.controls.proximity)
RegisterKeyMapping("+radio", "Fala no radio", "keyboard", mumbleConfig.controls.radio)
