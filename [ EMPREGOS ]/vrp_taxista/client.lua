...
local coordenadas = {
	{ ['id'] = 1, ['x'] = 896.47, ['y'] = -177.23, ['z'] = 74.70 }
			...
			for _,v in pairs(coordenadas) do
				...
				if distance <= 3 then
					...
					if distance <= 1.2 then
						uru = 5
						drawTxt("PRESSIONE  ~r~E~w~  PARA INICIAR O SERVIÇO POR ~g~$1000",4,0.5,0.93,0.50,255,255,255,180)
						if IsControlJustPressed(0,38) and emP.empresataxi() then
							servico = true
							if v.id == 2 then
								selecionado = 43
							else
							...
							TriggerEvent("Notify","importante","Você pagou <b>$1000<b> para iniciar o serviço.")
						end
					end
				end
			end
