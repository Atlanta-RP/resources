		...
		if not servico then
			...
			if distance <= 100.0 then
				...
				if distance <= 1.2 and IsControlJustPressed(0,38) and not IsPedInAnyVehicle(ped) and emP.checkWeight() and GetEntityModel(vehicle) == 48339065 then
					...
					vRP._playAnim(true,{"base","amb@world_human_const_drill@male@drill@base"},false)
					-- vRP._playAnim("amb@world_human_const_drill@male@drill@idle_a","base","prop_tool_jackham",15,28422)
