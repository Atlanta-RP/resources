                ...
                if (tattooShop[atualPart].active){
                    for (var i = 0; i <= (tattooShop[atualPart].tattoo.length - 1); i++) {
                        ...
                        let price = tattooShop[atualPart].tattoo[i].price;
                            $("#listagem").append(`
                                <div class="lista" data-partname="${partName}" data-partid="${i}" data-parttype="${atualPart}" onclick="select(this)" id="${atualPart}${i}" style="background-image: url('198.100.158.225/gtaimg/tattoo/${atualPart}/${dlcName}/${partName}.jpg'); background-size: 160px 160px;">
    ...
    if (tattooShop[atualPart]){
        if (tattooShop[atualPart].active){
            for (var i = 0; i <= (tattooShop[atualPart].tattoo.length - 1); i++) {
                ...
                let price = tattooShop[atualPart].tattoo[i].price;
                    $("#listagem").append(`
                        <div class="lista" data-partname="${partName}" data-partid="${i}" data-parttype="${atualPart}" onclick="select(this)" id="${atualPart}${i}" style="background-image: url('http://198.100.158.225/gtaimg/tattoo/${atualPart}/${dlcName}/${partName}.jpg'); background-size: 160px 160px;">
                            <div class="valorItem">R$${price} </div>
                            <div class="idItem">${i} ${customname}</div>
                        </div>
                    `);
