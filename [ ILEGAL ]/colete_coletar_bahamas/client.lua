...
emP = Tunnel.getInterface("costura_coletar_bahamas")
...
local servico = false
local selecionado = 0
local CoordenadaX = -1387.19
local CoordenadaY = -609.38
local CoordenadaZ = 30.32
local processo = fals
local segundos = 0 -- 
-----------------------------------------------------------------------------------------------------------------------------------------
-- LOCAIS   
	...
	while true do
		...
		if not servico then
			...
			if distance <= 1.5 then
				uru = 2
				DrawMarker(21,CoordenadaX,CoordenadaY,CoordenadaZ-0.5,0,0,0,0,0.5,0.5,0.5,0.5,0.5,255,165,0,30,1,0,0,1)
				if distance <= 1.5 then
					uru = 2
