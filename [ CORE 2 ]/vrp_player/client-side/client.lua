...
RegisterKeyMapping("keybindcuff","Algemar o Cidadao","keyboard","c")
-----------------------------------------------------------------------------------------------------------------------------------------
-- CARRY
-----------------------------------------------------------------------------------------------------------------------------------------
...
local disService = {
	...
	{ 361.01,-1590.01,29.3,"Police" }, -- Los Santos
...
AddEventHandler('setmascara',function(modelo,cor)
	...
	if GetEntityHealth(ped) > 101 and vSERVER.checkRoupas() then
		...
		if GetEntityModel(ped) == GetHashKey("mp_m_freemode_01") or GetEntityModel(ped) == GetHashKey("mp_f_freemode_01") then
			vRP._playAnim(true,{"mp_masks@on_foot","put_on_mask"},false)
			Wait(600)
			ClearPedTasks(ped)
...
AddEventHandler('setcolete',function(modelo,cor)
	...
	if GetEntityHealth(ped) > 101 and vSERVER.checkRoupas() then
		...
		if GetEntityModel(ped) == GetHashKey("mp_m_freemode_01") then
			vRP._playAnim(source,false,{ task = "PROP_HUMAN_BUM_BIN" },true)
			Wait(2500)
			ClearPedTasks(ped)
			SetPedComponentVariation(ped,9,parseInt(modelo),parseInt(cor),true)
		elseif GetEntityModel(ped) == GetHashKey("mp_f_freemode_01") then
			vRP._playAnim(true,{"clothingshirt","try_shirt_positive_d"},false)
			Wait(2500)
			ClearPedTasks(ped)
...
AddEventHandler('setjaqueta',function(modelo,cor)
	...
	if GetEntityHealth(ped) > 101 and vSERVER.checkRoupas() then
		...
		if GetEntityModel(ped) == GetHashKey("mp_m_freemode_01") then
			...
			Wait(2500)
			ClearPedTasks(ped)
			SetPedComponentVariation(ped,11,parseInt(modelo),parseInt(cor),true)
		elseif GetEntityModel(ped) == GetHashKey("mp_f_freemode_01") then
			vRP._playAnim(true,{"clothingshirt","try_shirt_positive_d"},false)
			Wait(2500)
			ClearPedTasks(ped)
...
AddEventHandler('setmaos',function(modelo,cor)
	...
	if GetEntityHealth(ped) > 101 and vSERVER.checkRoupas() then
		...
		if GetEntityModel(ped) == GetHashKey("mp_m_freemode_01") then
			...
			Wait(2500)
			ClearPedTasks(ped)
			SetPedComponentVariation(ped,3,parseInt(modelo),parseInt(cor),true)
		elseif GetEntityModel(ped) == GetHashKey("mp_f_freemode_01") then
			vRP._playAnim(true,{"clothingshirt","try_shirt_positive_d"},false)
			Wait(2500)
			ClearPedTasks(ped)
...
AddEventHandler('setcalca',function(modelo,cor)
	...
	if GetEntityHealth(ped) > 101 and vSERVER.checkRoupas() then
		...
		if GetEntityModel(ped) == GetHashKey("mp_m_freemode_01") then
			...
			Wait(2500)
			ClearPedTasks(ped)
			SetPedComponentVariation(ped,4,parseInt(modelo),parseInt(cor),true)
		elseif GetEntityModel(ped) == GetHashKey("mp_f_freemode_01") then
			vRP._playAnim(true,{"clothingtrousers","try_trousers_neutral_c"},false)
			Wait(2500)
			ClearPedTasks(ped)
...
AddEventHandler('setacessorios',function(modelo,cor)
	...
	if GetEntityHealth(ped) > 101 and vSERVER.checkRoupas() then
		...
		if GetEntityModel(ped) == GetHashKey("mp_m_freemode_01") then
			SetPedComponentVariation(ped,7,parseInt(modelo),parseInt(cor),true)
		elseif GetEntityModel(ped) == GetHashKey("mp_f_freemode_01") then
			SetPedComponentVariation(ped,7,parseInt(modelo),parseInt(cor),true)
		end
	end
...
AddEventHandler('setsapatos',function(modelo,cor)
	...
	if GetEntityHealth(ped) > 101 and vSERVER.checkRoupas() and not IsPedInAnyVehicle(ped) then
		...
		if GetEntityModel(ped) == GetHashKey("mp_m_freemode_01") then
			vRP._playAnim(false,{"clothingshoes","try_shoes_positive_d"},false)
			Wait(2200)
			SetPedComponentVariation(ped,6,parseInt(modelo),parseInt(cor),true)
			Wait(500)
			ClearPedTasks(ped)
		elseif GetEntityModel(ped) == GetHashKey("mp_f_freemode_01") then
			vRP._playAnim(false,{"clothingshoes","try_shoes_positive_d"},false)
