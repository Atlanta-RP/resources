...
RegisterCommand("call",function(source,args,rawCommand)
	...
	if user_id then
		...
		if args[1] == "911" then
			players = getUsersByPermission("Police")
			especialidade = "policiais"
		elseif args[1] == "112" then
			players = getUsersByPermission("Paramedic")
			especialidade = "paramédicos"
		elseif args[1] == "mec" then
			players = vRP.getUsersByPermission("Mechanic")
			especialidade = "mecânicos"
		-- elseif args[1] == "taxi" then
		-- 	players = vRP.getUsersByPermission("Taxi")
		-- 	especialidade = "taxistas"
		-- elseif args[1] == "adv" then
		-- 	players = vRP.getUsersByPermission("Advogado")
	...
	["Police"] = {
		["1"] = {
			["homem"] = {
				...
				["pants"] = { item = 131, texture = 3, defaultItem = 0, defaultTexture = 0 },
				["vest"] = { item = 49, texture = 0, defaultItem = 0, defaultTexture = 0 },
				...
				["shoes"] = { item = 108, texture = 0, defaultItem = 1, defaultTexture = 0 },
				["t-shirt"] = { item = 167, texture = 0, defaultItem = 1, defaultTexture = 0 },
				["bag"] = { item = 0, texture = 0, defaultItem = 0, defaultTexture = 0 },
				["torso2"] = { item = 32, texture = 0, defaultItem = 0, defaultTexture = 0 },
				["accessory"] = { item = -1, texture = 0, defaultItem = 0, defaultTexture = 0 },
				["watch"] = { item = -1, texture = 0, defaultItem = -1, defaultTexture = 0 },
				["arms"] = { item = 11, texture = 0, defaultItem = 0, defaultTexture = 0 },
		...
		["2"] = {
			["homem"] = {
				...
				["vest"] = { item = 49, texture = 0, defaultItem = 0, defaultTexture = 0 },
				["bracelet"] = { item = -1, texture = 0, defaultItem = -1, defaultTexture = 0 },
				["decals"] = { item = 67, texture = 0, defaultItem = 0, defaultTexture = 0 },
				["mask"] = { item = 0, texture = 0, defaultItem = 0, defaultTexture = 0 },
				["shoes"] = { item = 108, texture = 0, defaultItem = 1, defaultTexture = 0 },
				["t-shirt"] = { item = 167, texture = 0, defaultItem = 1, defaultTexture = 0 },
				["bag"] = { item = 0, texture = 0, defaultItem = 0, defaultTexture = 0 },
			...
			["mulher"] = {
				...
				["glass"] = { item = 15, texture = 1, defaultItem = 0, defaultTexture = 0 },
				["ear"] = { item = -1, texture = 0, defaultItem = -1, defaultTexture = 0 }
			}
		},
		["3"] = {
			["homem"] = {
				...
				["vest"] = { item = 49, texture = 0, defaultItem = 0, defaultTexture = 0 },
				["bracelet"] = { item = -1, texture = 0, defaultItem = -1, defaultTexture = 0 },
				["decals"] = { item = 67, texture = 1, defaultItem = 0, defaultTexture = 0 },
				["mask"] = { item = 0, texture = 0, defaultItem = 0, defaultTexture = 0 },
				["shoes"] = { item = 108, texture = 0, defaultItem = 1, defaultTexture = 0 },
				["t-shirt"] = { item = 167, texture = 0, defaultItem = 1, defaultTexture = 0 },
				["bag"] = { item = 0, texture = 0, defaultItem = 0, defaultTexture = 0 },
		...
		["4"] = {
			["homem"] = {
				...
				["vest"] = { item = 49, texture = 0, defaultItem = 0, defaultTexture = 0 },
				["bracelet"] = { item = -1, texture = 0, defaultItem = -1, defaultTexture = 0 },
				["decals"] = { item = 67, texture = 2, defaultItem = 0, defaultTexture = 0 },
				["mask"] = { item = 0, texture = 0, defaultItem = 0, defaultTexture = 0 },
				["shoes"] = { item = 108, texture = 0, defaultItem = 1, defaultTexture = 0 },
				["t-shirt"] = { item = 167, texture = 0, defaultItem = 1, defaultTexture = 0 },
				["bag"] = { item = 0, texture = 0, defaultItem = 0, defaultTexture = 0 },
	...
	["Paramedic"] = {
		["1"] = {
			["homem"] = {
                ...
                ["decals"] = { item = 0, texture = 0, defaultItem = 0, defaultTexture = 0 },
                ["mask"] = { item = 121, texture = 0, defaultItem = 0, defaultTexture = 0 },
                ["shoes"] = { item = 20, texture = 3, defaultItem = 1, defaultTexture = 0 },
                ["t-shirt"] = { item = 31, texture = 0, defaultItem = 1, defaultTexture = 0 },
                ["bag"] = { item = 0, texture = 0, defaultItem = 0, defaultTexture = 0 },
...
function cnVRP.checkRoupas()
	...
	if user_id then
		...
		if vRP.getInventoryItemAmount(user_id,"roupas") >= 1 or vRP.hasPermission(user_id,"Admin") then
			...
			TriggerClientEvent("Notify",source,"negado","Você não possui <b>Roupas Secundárias</b> na mochila.",3000) 
			return false
		end
	end
end
