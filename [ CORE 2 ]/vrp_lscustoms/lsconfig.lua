...
LSC_Config.prices = {
	...
	xenoncolor = {
		{ name = "White", xenon = 0, price = 4000 },
		{ name = "Blue", xenon = 1, price = 4000 },
		{ name = "Electric Blue", xenon = 2, price = 4000 },
		{ name = "Mint Green", xenon = 3, price = 4000 },
		{ name = "Lime Green", xenon = 4, price = 4000 },
		{ name = "Yellow", xenon = 5, price = 4000 },
		{ name = "Golden Shower", xenon = 6, price = 4000 },
		{ name = "Orange", xenon = 7, price = 4000 },
		{ name = "Red", xenon = 8, price = 4000 },
		{ name = "Pony Pink", xenon = 9, price = 4000 },
		{ name = "Hot Pink",xenon = 10, price = 4000 },
		{ name = "Purple", xenon = 11, price = 4000 },
	...
	mods = {
		...
		[15] = {
			...
			{ name = "Street Suspension", mod = 1, price = 7000 },
			{ name = "Sport Suspension", mod = 2, price = 10000 },
			{ name = "Race Suspension", mod = 3, price = 12000 }
		},
		[14] = {
		...
		[12] = {
			...
			{ name = "Sport Brakes", mod = 1, price = 15000 },
			{ name = "Race Brakes", mod = 2, price = 20000 }
		},
		[11] = {
			{ name = "Lowered Engine", mod = 0, price = 10000 },
			{ name = "Street Engine", mod = 1, price = 12000 },
			{ name = "Sports Engine", mod = 2, price = 15000 },
			{ name = "Race Engine", mod = 3, price = 20000 }
		},
		[10] = {
			startprice = 1000,
			increaseby = 0
