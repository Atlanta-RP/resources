...
local garages = {
	...
	[1] = { locked = false, camera = { x = 737.09, y = -1085.72, z = 22.16, heading = 114.86 }, driveout = { x = 725.46, y = -1088.82, z = 21.45, heading = 89.39 }, drivein = { x = 726.15, y = -1088.76, z = 22.16, heading = 270.28 }, outside = { x = 716.54, y = -1088.75, z = 21.65, heading = 89.24 }, inside = { x = 733.69, y = -1088.74, z = 21.73, heading = 270.52 }},
...
local LSCMenu = Menu.new("Bennys","CATEGORIAS",0.16,0.13,0.24,0.36,0,{255,255,255,255})
						...
						if distance <= 5 then
							...
							if not v.locked then
								if IsControlJustPressed(1,201) then
									...
									DrawMarker(36,outside.x,outside.y,outside.z+0.30,0,0,0,0,0.0,130.0,0.6,0.8,0.50,0, 129, 254,100,0,0,0,1)
