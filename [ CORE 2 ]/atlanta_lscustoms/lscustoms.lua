...
emP = Tunnel.getInterface("atlanta_lscustoms")
...
local garages = {
	...
	-- GARAGEM ILEGAL [2] = { locked = false, camera = { x = 737.09, y = -1085.72, z = 22.16, heading = 114.86 }, driveout = { x = 725.46, y = -1088.82, z = 21.45, heading = 89.39 }, drivein = { x = 726.15, y = -1088.76, z = 22.16, heading = 270.28 }, outside = { x = 716.54, y = -1088.75, z = 21.65, heading = 89.24 }, inside = { x = 733.69, y = -1088.74, z = 21.73, heading = 270.52 }},
	[2] = { locked = false, camera = { x = -1154.90, y = -2011.43, z = 13.18, heading = 95.49 }, driveout = { x = -1150.37, y = -1995.84, z = 12.46, heading = 313.59 }, drivein = { x = -1150.26, y = -1995.64, z = 12.46, heading = 136.85 }, outside = { x = -1140.35, y = -1985.89, z = 12.45, heading = 314.40 }, inside = { x = -1155.07, y = -2006.61, z = 12.46, heading = 162.58 }},
	--[3] = { locked = false, camera = { x = 1177.98, y = 2636.05, z = 37.75, heading = 37.08 }, driveout = { x = 1175.00, y = 2642.17, z = 37.04, heading = 0.75 }, drivein = { x = 1174.70, y = 2643.76, z = 37.04, heading = 178.11 }, outside = { x = 1175.56, y = 2652.81, z = 37.94, heading = 351.57 }, inside = { x = 1174.82, y = 2637.80, z = 37.04, heading = 181.19 }},
	--[3] = { locked = false, camera = { x = 105.82, y = 6627.56, z = 31.78, heading = 266.69 }, driveout = { x = 112.32, y = 6625.14, z = 31.07, heading = 224.64 }, drivein = { x = 112.73, y = 6624.64, z = 31.07, heading = 44.26 }, outside = { x = 118.49, y = 6618.89, z = 31.13, heading = 224.70 }, inside = { x = 108.84, y = 6628.44, z = 31.07, heading = 45.50 }},
	[3] = { locked = false, camera = { x = -215.51, y = -1329.13, z = 30.89, heading = 329.09 }, driveout = { x = -205.93, y = -1316.64, z = 30.17, heading = 356.49 }, drivein = { x = -205.62, y = -1314.99, z = 30.24, heading = 179.39 }, outside = { x = -205.59, y = -1304.08, z = 30.61, heading = 359.79 }, inside = { x = -212.36, y = -1325.48, z = 30.17, heading = 141.10 } },
	[4] = { locked = false, camera = { x = 547.1, y = -175.4, z = 54.06, heading = 1 }, driveout = { x = 547.1, y = -175.4, z = 54.06, heading = 1  }, drivein = { x = 547.1, y = -175.4, z = 54.06, heading = 1  }, outside = { x = 547.1, y = -175.4, z = 54.06, heading = 1  }, inside = { x = 547.1, y = -175.4, z = 54.06, heading = 1 } },
	[5] = { locked = false, camera = { x = 548.38, y = -191.72, z = 54.08, heading = 1.34 }, driveout = { x = 548.38, y = -191.72, z = 54.08, heading = 1.34  }, drivein = { x = 548.38, y = -191.72, z = 54.08, heading = 1.34  }, outside = { x = 548.38, y = -191.72, z = 54.08, heading = 1.34  }, inside = { x = 548.38, y = -191.72, z = 54.08, heading = 1.34 } }
}
...
local function DriveInGarage()
	...
	if DoesEntityExist(veh) then
		LSCMenu:setTitle("Atlanta Motorworks")
