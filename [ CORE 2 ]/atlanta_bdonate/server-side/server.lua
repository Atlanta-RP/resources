...
-----------------------------------------------------------------------------------------------------------------------------------------
cnVRP = {}
Tunnel.bindInterface("atlanta_bdonate",cnVRP)
vCLIENT = Tunnel.getInterface("atlanta_bdonate")
...
AddEventHandler("vRP:playerSpawn",function(user_id,source)
	TriggerClientEvent("atlanta_bdonate:syncVehicles",source,beneModels)
	TriggerClientEvent("atlanta_bdonate:syncList",source,typeCars,typeBikes)
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- SETVEHICLES
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("atlanta_bdonate:setVehicles")
AddEventHandler("atlanta_bdonate:setVehicles",function(veh,slot)
	beneModels[slot].model = veh
	TriggerClientEvent("atlanta_bdonate:syncVehicles",-1,beneModels)
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- GETOWNED
-----------------------------------------------------------------------------------------------------------------------------------------
...
-- vagaIndisponivel
-----------------------------------------------------------------------------------------------------------------------------------------
function cnVRP.vagaIndisponivel()
	TriggerClientEvent("Notify",source,"negado","Vaga indisponível nesta loja.",5000)
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- REQUESTBUY
-----------------------------------------------------------------------------------------------------------------------------------------
