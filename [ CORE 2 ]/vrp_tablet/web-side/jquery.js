...
$(function(){
	...
	var actionButtom = $("#actionbuttom");
	var policeCalcButton = $("#policecalcbutton");
	...
	window.addEventListener('message',function(event){
		...
		if (item.isPolice){
			policeCalcButton.show();
		} else {
			policeCalcButton.hide();
		}
...
$('#versao').innerText =sendData("versao","versao");

function sendData(name,data){
	$.post("http://vrp_tablet/"+name,JSON.stringify(data),function(datab){
		if (datab != "ok"){
			console.log(datab);
		}
	});
