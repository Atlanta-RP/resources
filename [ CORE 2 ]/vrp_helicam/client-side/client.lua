...
local toggle_helicam = 44 -- control id of the button by which to toggle the helicam mode. Default: INPUT_CONTEXT (E)
...
local toggle_display = 51 -- control id to toggle vehicle info display. Default: INPUT_COVER (Q)
