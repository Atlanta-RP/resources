...
vSERVER = Tunnel.getInterface("atlanta_bank")
-----------------------------------------------------------------------------------------------------------------------------------------
-- LOCALIDADES
-----------------------------------------------------------------------------------------------------------------------------------------
local localidades = {
...
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNUICallback("requestMyTransferencias",function(data,cb)
	local resultado = vSERVER.requestMyTransferencias()
	while not resultado do
		resultado = vSERVER.requestMyTransferencias()
		Citizen.Wait(10)
	end
...
RegisterNUICallback("bankTransfer",function(data)
	...
	if parseInt(data.valor) > 0 and parseInt(data.destinatario) > 0 then
		vSERVER.bankTransferir(data.destinatario, data.valor)
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- REQUESTDEPOSITO
...
AddEventHandler("atlanta_bank:Updates12ds",function(action)
