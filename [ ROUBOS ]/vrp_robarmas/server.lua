...
-----------------------------------------------------------------------------------------------------------------------------------------
func = {}
Tunnel.bindInterface("vrp_robarmas",func)
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookrouboarmas = "https://discord.com/api/webhooks/813928606224613447/S2Yx68peIb3zX3R0AZj7Aj9Sii1YL86-1tzKcwFg3Ptn7AGsisXGVvWtIto5ed9r-qFP"
...
local armalist = {
	...
	[6] = { ['index'] = "wbody|WEAPON_SMG", ['qtd'] = 1, ['name'] = "MPX" },
	...
	[13] = { ['index'] = "wammo|WEAPON_SMG", ['qtd'] = 50, ['name'] = "MUNIÇÃO DE MPX" },
	...
	if user_id then
		...
		if #policia >= 1 then
			if timers[id] == 0 or not timers[id] then
				...
				SendWebhookMessage(webhookrouboarmas,"```prolog\n[ID]: "..user_id.." "..identity.name.." "..identity.firstname.." "..armalist[randitem].name.."  "..os.date("\n[Data]: %d/%m/%Y [Hora]: %H:%M:%S").." \r```")
