...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookbankrobbery = "https://discord.com/api/webhooks/813928475907325952/UH3U-NqWHE_lxFkk-b-KMj70bOxGBZfHuRN2RGz0yAl3jxD57OdB_YrlGlYdttTKq_qP"
...
function vRPrb.updateCops(message)
    ...
    local user_id = vRP.getUserId(source)
    if user_id then
        TriggerClientEvent('chatMessage', -1, "[AWKN NEWS BANCO CENTRAL]", {64,64,255}, message)
    end
end
